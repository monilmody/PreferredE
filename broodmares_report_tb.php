...
$resultFound = fetchBroodmaresReport_tb($salecode_param,$year_param,$type_param,$gait_param,
...
<h1 style="text-align:center;color:#D98880;">BROODMARES REPORT THOROUGHBRED</h1>
<!-- <b> -->
	...
	<div class="table" style="width: device-width">
          ...
          <?php
            ...
            foreach($resultFound as $row) {
                ...
                $offspings = fetchOffsprings_broodmare_tb($row['Horse'], $year_param);
...
function getValues() {
    ...
    var link ="broodmares_report_tb.php?year="+year
    							+"&salecode="+salecode
    							+"&type="+type
    							+"&gait="+gait
    							+"&sex="+sex
...
function downloadData(){
    ...
    var link ="broodmares_report_tb_download.php?year="+year
    							+"&salecode="+salecode
    							+"&type="+type
    							+"&gait="+gait
    							+"&sex="+sex

...
$sortList = array("BuyerLastName", "BuyerFirstName", "Total Asc", "Total Desc", "Gross Asc", "Gross Desc", "Avg Asc", "Avg Desc");
?>
...
<div class="container">
  ...
  <!-- Sorting Selects for Sort2, Sort3, Sort4, Sort5 -->
  ...
  <div style="max-height: calc(96.2vh - 96.2px); overflow:auto;">
    <div class="table" style="width: device-width;">
      ...
      <div class="row header green" style="line-height: 25px; font-size: 12px; border: 1px solid black; position: sticky; top: 0;">
        ...
        <div class="cell" style="width: device-width;">BUYERS FULL NAME</div>
        <div class="cell" style="width: device-width;">TOTAL NO PURCHASED</div>
        <div class="cell" style="width: device-width;">GROSS</div>
        <div class="cell" style="width: device-width;">AVERAGE</div>
      </div>
      ...
      foreach($resultFound as $row) {
          ...
          // Display Buyer Full Name with Collapsible Section
          echo "<div class='cell'>";
          ...
          echo $row['BuyerFullName'];  // Display the actual buyer's full name dynamically
          echo "</button>";
          echo "</div>";

          // Loop through and display Total, Gross, and Average
          foreach($row as $key => $elements) {
              if ($key === 'Horses') {
                  continue; // Skip 'Horses' in the main row display
              }

              $elementCount++;
              
              // Format as money for Gross and Average fields

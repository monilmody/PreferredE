...
<!--                             <li><a href="registration.php">Register</a></li>  -->  
    ...
    <script>
// Global fix for dropdown issues on ALL pages
$(document).ready(function() {
    // Check if we're on myaccount.php
    if (window.location.pathname.includes('myaccount.php')) {
        console.log('On myaccount.php - applying dropdown fix');
        
        // Force remove any problematic overlays
        $('.modal-backdrop').remove();
        $('body').removeClass('modal-open');
        
        // Reinitialize dropdowns with force
        $('.dropdown-toggle').dropdown('dispose').dropdown();
        
        // Add a direct click handler that overrides everything

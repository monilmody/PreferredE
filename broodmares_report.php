...
$resultFound = fetchBroodmaresReport($salecode_param,$year_param,$type_param,$gait_param,
...
$defaultType = 'B';
$sortList = array("Hip","Horse","Type", "Gait", "Price Desc", "Salecode", "Day", "Consno","Sire" ,"Dam" , "Bredto", "Lastbred", "Age","Rating");
...
<h1 style="text-align:center;color:#D98880;">BROODMARES REPORT </h1>
<!-- <b> -->
          ...
          <?php
            ...
            foreach($resultFound as $row) {
                ...
                foreach($row as $elements) {
                  ...
                  $offspings = fetchOffsprings_broodmare($row['Horse'], $year_param);
...
function getValues() {
    ...
    var link ="broodmares_report.php?year="+year
    							+"&salecode="+salecode
    							+"&type="+type
    							+"&gait="+gait
    							+"&sex="+sex
...
function downloadData(){
    ...
    var link ="broodmares_report_download.php?year="+year
    							+"&salecode="+salecode
    							+"&type="+type
    							+"&gait="+gait
    							+"&sex="+sex

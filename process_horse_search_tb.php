...
$resultFound = fetchRecords_tb($horseName);

$offspings = fetchOffsprings_tb($horseName);
...
$damsofdamOffspings = fetchOffsprings_tb($damofdamName);
...
<div class="container">
<div>
   <form style="float:right;" autocomplete="off" class="example" name="dam" action="process_horse_search_tb.php" method="post" style="margin:auto;">
      ...
      <div id="collapse1" class="panel-collapse collapse in">
       ...
       <div class="table" style="width: 100%;table-layout: fixed;">
          <div class="row header blue">
        	<?php
          	include("./horse_search_table_header_tb.php");
          	?>
          </div>
          ...
          <?php
              ...
              foreach($resultFound as $row) {
                  ...
                  foreach($row as $elements) {
                      ...
                      if ($elementCount == 7 or $elementCount == 17) {
                          if ($elements != "") {

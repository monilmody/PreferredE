...
// NUCLEAR OPTION - Force dropdowns to work
$(document).ready(function() {
    // Wait a bit to ensure everything is loaded
    setTimeout(function() {
        // Completely reinitialize ALL dropdowns
        $('.dropdown').each(function() {
            $(this).removeClass('show');
            $(this).find('.dropdown-menu').removeClass('show');
        });
        
        // Remove ALL event handlers and add fresh ones
        $('.dropdown-toggle').off('click.bs.dropdown.data-api')
            .off('click')
            .on('click', function(e) {
                e.preventDefault();
        ...
        $(document).off('click.bs.dropdown.data-api').on('click', function(e) {
        ...
        console.log('Dropdown fix applied - should work now');
    }, 300);
});

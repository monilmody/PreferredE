...
$sortList = array("Hip","Horse","Sex", "Type", "Gait", "Price Desc", "Salecode", "Day", "Consno","Sire" ,"Dam" , "Bredto", "Lastbred", "Age","Age Desc","Rating","Sire");
...
<h1 style="text-align:center;color:#D98880;">SALES REPORT </h1>
<b>
...
function getValues() {
    ...
    var link ="sales_report.php?year="+year
    							+"&salecode="+salecode
    							+"&type="+type
    							+"&gait="+gait
    							+"&sex="+sex
...
function downloadData(){
    ...
    var link ="sales_report_download.php?year="+year
    							+"&salecode="+salecode
    							+"&type="+type
    							+"&gait="+gait
    							+"&sex="+sex

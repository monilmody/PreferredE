...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['column_prefs'])) {
    ...
    header("Location: horse_list_tb.php");
    exit();
}
...
$result = fetchHorseListTb($sort1_param, $sort2_param, $sort3_param, $sort4_param, $sort5_param, $horseSearch, $damSearch, $LocationSearch, $FoalSearch, $ConsignerSearch, $SalecodeSearch, $salecodeFilter, $farmnameFilter, $farmcodeFilter);
$salcodeList = fetchSalecodeList_tb($year_param);
$farmnameList = fetchFarmnameList_tb($year_param);
$farmcodeList = fetchFarmcodeList_tb($year_param);
...
<h1 style="text-align:center;color:#FF6B35;">HORSE LIST - THOROUGHBRED</h1>

<div class="search-container">
    <form class="form-inline" action="horse_list_tb.php" method="GET">
    ...
    <div id="horseDetailsSidebar" class="sidebar">
        ...
        <script>
            ...
            function getValues() {
                ...
                var link = "horse_list_tb.php?&sort1=" + sort1 +
            ...
            document.querySelectorAll('input[type="checkbox"]').forEach(checkbox => {
                checkbox.addEventListener('change', function() {
                    ...
                    fetch('update_inspection_tb.php', {
                            method: 'POST',
                            headers: {
            ...
            function loadHorseInspection(horseName) {
                ...
                fetch(`get_horse_values_tb.php?horseId=${encodeURIComponent(horseName)}`)
                    .then(response => {
                        if (!response.ok) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            // Pedigree
                            $('#sireTitle').text(response.tSire || 'N/A');
                            $('#sireDisplay').text(response.tSire || 'N/A');
                            $('#damTitle').text(response.TDAM || 'N/A');
                            $('#damDisplay').text(response.TDAM || 'N/A');
                            $('#sireofdamDisplay').text(response.tSireofdam || 'N/A');
...
<div class="photo-card">
    ...
    `;
            ...
            $(document).on('click', '#saveBtn', function() {
                ...
                $.ajax({
                    url: 'update_horse_details_tb.php',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        horseId: horseId,

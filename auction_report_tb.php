...
$resultFound = fetchSalesAuctionReport_tb($year_param,$type_param,$salecode_param);

$resultFound21 = fetchSalesSummary_tb($year_param,$type_param,$salecode_param);
...
<div class="container">
<h1 style="text-align:center;color:#D98880;">THOROUGHBRED AUCTION REPORT</h1>
...
<hr>
 ...
 <hr>
 <div style="height:500px;overflow:auto;">
	<div class="table" style="width: device-width;table-layout: fixed;">
...
function getValues() {
    ...
    var link ="auction_report_tb.php?year="+year
    						     +"&type="+type
    						     +"&salecode="+salecode;

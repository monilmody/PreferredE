...
$resultFound = fetchTopBuyers($year_param,$sort1_param,$sort2_param,$sort3_param,$sort4_param,$sort5_param);
...
<div class="container">
<h1 style="text-align:center;color:#D98880;">TOP YEARLING BUYERS</h1>
...
function getValues() {
    ...
    var link ="top_buyers.php?year="+year
    							+"&sort1="+sort1
    							+"&sort2="+sort2
    							+"&sort3="+sort3
    							+"&sort4="+sort4
